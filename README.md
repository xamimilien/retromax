...
La version courante est **0.0.31**. Chaque nouvelle livraison terminée et testée incrémente le dernier nombre (`0.0.32`, `0.0.33`, etc.), met à jour le cache PWA, puis est fusionnée dans `main` et marquée par un tag Git correspondant (`v0.0.XX`).
